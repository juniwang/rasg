            ...
            if(automode === "true"){
                ...
                var _auto_task = w.setInterval(function(){
                    if(fn_index >= user.fn.length){
                        ...
                        var fn = user.fn[fn_index].split("@")[0];
                        var fn_param = user.fn[fn_index].split("@")[1];
                        switch(fn){
                            case "signin":
                                //auto SignIn
                            ...
                            case "fuben":
                                if(!fuben_init){
                                    if(fuben_refresh.length==0){
                                        // query all fubens status
                                        Mojo.ajax('/fuben/fubens', {}, function (result){
                                            if(result.errorCode==0){
                                        ...
                                        //reset fuben
                                        Mojo.ajax('/fuben/fbTasks', {fuben_id:fuben_refresh[0].id,fuben_refresh:1}, function (result) {
                                            if(result.errorCode == 0){
                                                Mojo.app.toast.show2("[副本]["+fuben_refresh[0].name +"]重置成功");
                                            }
                                            fuben_refresh.splice(0,1);
                                            if(fuben_refresh.length==0) fuben_init = true;
                                        }, function () {}); 
                                    }                                    
                                    ...
                                    if(fb_tasks.length==0){
                                        ...
                                        Mojo.ajax("/fuben/fbTasks", {"fuben_id":cur_fuben.id}, function (response) {
                                            if(response.errorCode==0){
                                                ...
                                                if(cur_fuben_index>=fubens.length) fn_index=fn_index+1;
                                            }
                                        }, function(){});
                                    }else{
                                            ...
                                            Mojo.ajax("/fuben/do",{id: fb_tasks[t_i].id},function(result){
                                                ...
                                                if(result.errorCode == 160003){
                                                    ...
                                                    if(result.data.fb_task.status==3){
                                                        //get award
                                                        if(!is_boss_group && fn_param!="noaward"){
                                                            setTimeout(function(){
                                                                 Mojo.ajax("/fuben/openAward", {
                                                                    ...
                                                                    if(result.errorCode==0){
                                                                        Mojo.app.toast.show2("[副本]["+fuben_name+"]["+group_name+"]领奖获得："+result.data.entity.name);
                                                                    }
                                                                }, function () {});
                                                            },2000);
                                                        }
